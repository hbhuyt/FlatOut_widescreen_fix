========================================================================
    ...
    flatout_widescreen_fix
========================================================================

Эта библиотека DLL flatout_widescreen_fix создана автоматически с помощью 
мастера приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения flatout_widescreen_fix.


flatout_widescreen_fix.vcxproj
...
flatout_widescreen_fix.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем flatout_widescreen_fix.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
